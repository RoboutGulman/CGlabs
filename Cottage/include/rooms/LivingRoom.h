...
public:
	LivingRoom()
	{
		std::unique_ptr<IPolytopeDrawable> room = std::make_unique<TextureCube>(std::move(std::make_unique<Cube>(1.3f, 0.4f, 1.0f, glm::vec3{ 0, 0.3f, 0 })), "include\\model\\assets\\accentBrickwall.jpg");
